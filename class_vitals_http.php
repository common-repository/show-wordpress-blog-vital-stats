...
class vitals_http {
    ...
    */ 
    function vitals_http() {
        $this->log = "New vitals_http() object instantiated.<br />\n";
    ...
    */
    function table_into_xml($rawHTML,$needle="",$needle_within=0,$allowedTags="") {
        if (!$aryTable = vitals_http::table_into_array($rawHTML,$needle,$needle_within,$allowedTags)) { return false; }
